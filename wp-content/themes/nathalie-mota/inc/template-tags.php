...
if ( ! function_exists( 'nathalie_mota_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function nathalie_mota_posted_on() {
...
if ( ! function_exists( 'nathalie_mota_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function nathalie_mota_posted_by() {
		$byline = sprintf(
			/* translators: %s: post author. */
			esc_html_x( 'by %s', 'post author', 'nathalie-mota' ),
...
if ( ! function_exists( 'nathalie_mota_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function nathalie_mota_entry_footer() {
...
if ( ! function_exists( 'nathalie_mota_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function nathalie_mota_post_thumbnail() {
